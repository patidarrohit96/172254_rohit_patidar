...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <li class="active"><a href="/SpringOnlineShopping2/login">LOGIN</a></li>
...
<div style="color:green">${message}</div>
 ...
 <a  style="color:green"  href = "/SpringOnlineShopping2/register" ><p style="text-align:center">New user click here</a>
